            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              <div className="sr-stagger mt-9 grid gap-6 md:grid-cols-3">
                <div className="sr-fade-up rounded-2xl bg-white p-8 shadow-card">
                  <FeatureIcon name="tools" className="feature-ico shrink-0" />
          ...
          <section className="py-12 md:py-16">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              <div className="sr-stagger mt-9 grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-3">
                <div className="sr-fade-up rounded-2xl bg-white p-4 sm:p-7 shadow-card"><FeatureIcon name="measure" className="feature-ico shrink-0" /><h3 className="mt-5 text-lg font-bold text-gray-900">{text(blocks, "h3.science-experiments", "Science Experiments")}</h3><p className="mt-3 text-sm leading-6 text-gray-600">{text(blocks, "p.interactive-experiments-that-make-science", "Interactive experiments that make science exciting.")}</p></div>
                <div className="sr-fade-up rounded-2xl bg-white p-4 sm:p-7 shadow-card"><FeatureIcon name="chip" className="feature-ico shrink-0" /><h3 className="mt-5 text-lg font-bold text-gray-900">Robotics</h3><p className="mt-3 text-sm leading-6 text-gray-600">{text(blocks, "p.build-and-program-simple-robots", "Build and program simple robots.")}</p></div>
                <div className="sr-fade-up rounded-2xl bg-white p-4 sm:p-7 shadow-card"><FeatureIcon name="code" className="feature-ico shrink-0" /><h3 className="mt-5 text-lg font-bold text-gray-900">Coding</h3><p className="mt-3 text-sm leading-6 text-gray-600">{text(blocks, "p.learn-programming-through-games-and", "Learn programming through games and challenges.")}</p></div>
                <div className="sr-fade-up rounded-2xl bg-white p-4 sm:p-7 shadow-card"><FeatureIcon name="send" className="feature-ico shrink-0" /><h3 className="mt-5 text-lg font-bold text-gray-900">{text(blocks, "h3.drone-demonstrations", "Drone Demonstrations")}</h3><p className="mt-3 text-sm leading-6 text-gray-600">{text(blocks, "p.experience-the-future-of-aviation", "Experience the future of aviation and technology.")}</p></div>
                <div className="sr-fade-up rounded-2xl bg-white p-4 sm:p-7 shadow-card"><FeatureIcon name="settings" className="feature-ico shrink-0" /><h3 className="mt-5 text-lg font-bold text-gray-900">{text(blocks, "h3.engineering-challenges", "Engineering Challenges")}</h3><p className="mt-3 text-sm leading-6 text-gray-600">{text(blocks, "p.design-build-test-and-improve", "Design, build, test, and improve creative solutions.")}</p></div>
                <div className="sr-fade-up rounded-2xl bg-white p-4 sm:p-7 shadow-card"><FeatureIcon name="mission" className="feature-ico shrink-0" /><h3 className="mt-5 text-lg font-bold text-gray-900">STEM Games</h3><p className="mt-3 text-sm leading-6 text-gray-600">{text(blocks, "p.collaborative-competitions-that-strengthen-teamwork", "Collaborative competitions that strengthen teamwork and problem solving.")}</p></div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white py-12 md:py-16">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              <div className="sr-stagger mt-9 grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
                <article className="sr-fade-up rounded-2xl bg-white p-4 sm:p-7 shadow-card"><FeatureIcon name="measure" className="feature-ico shrink-0" /><h3 className="mt-5 text-lg font-bold text-gray-900">Science</h3><ul className="mt-3 space-y-1.5 text-sm text-gray-600"><li>Experiments</li><li>Biology</li><li>Chemistry</li><li>Physics</li></ul></article>
                <article className="sr-fade-up rounded-2xl bg-white p-4 sm:p-7 shadow-card"><FeatureIcon name="screen" className="feature-ico shrink-0" /><h3 className="mt-5 text-lg font-bold text-gray-900">Technology</h3><ul className="mt-3 space-y-1.5 text-sm text-gray-600"><li>Digital Literacy</li><li>Computers</li><li>Coding</li><li>Internet Safety</li></ul></article>
                <article className="sr-fade-up rounded-2xl bg-white p-4 sm:p-7 shadow-card"><FeatureIcon name="tools" className="feature-ico shrink-0" /><h3 className="mt-5 text-lg font-bold text-gray-900">Engineering</h3><ul className="mt-3 space-y-1.5 text-sm text-gray-600"><li>Design Challenges</li><li>Bridge Building</li><li>Model Construction</li><li>Simple Machines</li></ul></article>
                <article className="sr-fade-up rounded-2xl bg-white p-4 sm:p-7 shadow-card"><FeatureIcon name="maths" className="feature-ico shrink-0" /><h3 className="mt-5 text-lg font-bold text-gray-900">Mathematics</h3><ul className="mt-3 space-y-1.5 text-sm text-gray-600"><li>Logic</li><li>Geometry</li><li>Problem Solving</li><li>Applied Mathematics</li></ul></article>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white py-12 md:py-16">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              <ol className="sr-stagger mx-auto mt-9 grid max-w-6xl grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
                <li className="sr-fade-up flex flex-col items-center rounded-2xl bg-orange-500 p-5 text-center text-white"><FeatureIcon name="joy" className="feature-ico shrink-0" /><p className="mt-3 text-sm font-semibold">{text(blocks, "p.youth-stem-school", "Youth STEM School")}</p></li>
                <li className="sr-fade-up flex flex-col items-center rounded-2xl bg-white p-5 text-center shadow-card"><FeatureIcon name="book" className="feature-ico shrink-0" /><p className="mt-3 text-sm font-semibold text-gray-900">{text(blocks, "p.secondary-research", "Secondary Research")}</p></li>
                <li className="sr-fade-up flex flex-col items-center rounded-2xl bg-white p-5 text-center shadow-card"><FeatureIcon name="award" className="feature-ico shrink-0" /><p className="mt-3 text-sm font-semibold text-gray-900">{text(blocks, "p.scholarships", "Scholarships")}</p></li>
                <li className="sr-fade-up flex flex-col items-center rounded-2xl bg-white p-5 text-center shadow-card"><FeatureIcon name="search" className="feature-ico shrink-0" /><p className="mt-3 text-sm font-semibold text-gray-900">{text(blocks, "p.university-research", "University Research")}</p></li>
                <li className="sr-fade-up flex flex-col items-center rounded-2xl bg-white p-5 text-center shadow-card"><FeatureIcon name="work" className="feature-ico shrink-0" /><p className="mt-3 text-sm font-semibold text-gray-900">{text(blocks, "p.internships-mentorship", "Internships & Mentorship")}</p></li>
                <li className="sr-fade-up flex flex-col items-center rounded-2xl bg-white p-5 text-center shadow-card"><FeatureIcon name="growth" className="feature-ico shrink-0" /><p className="mt-3 text-sm font-semibold text-gray-900">{text(blocks, "p.careers-leadership", "Careers & Leadership")}</p></li>
              </ol>
            </div>
          </section>
