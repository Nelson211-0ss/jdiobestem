...
const { sendEmailNotification, sendDonorThankYou, appendToSheet } = require('./donationNotifications');
...
async function recordDonation(donation) {
  ...
  const labels = ['[donation:email]', '[donation:donor-thankyou]', '[donation:sheet]'];
  results.forEach((r, i) => {
